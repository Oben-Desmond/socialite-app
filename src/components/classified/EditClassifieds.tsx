                    ...
                    <IonCardContent>
                        <form onSubmit={editPost} action="">
                            ...
                            <div style={{ whiteSpace: `pre-wrap` }} className="input">
                                <IonTextarea  rows={4}   value={input.desc} onIonChange={e => setinput({ ...input, desc: (e.detail.value || ``) })} required name={`desc`} placeholder={`Enter Description of Item`}></IonTextarea>
                            </div>
                            <div className={`input`}>
